...
public class ApplicationConfigurerAdapter extends WebMvcConfigurerAdapter implements EnvironmentAware  {
    ...
    public void addInterceptors(final InterceptorRegistry registry)  {
        registry.addInterceptor(pagePopulationInterceptor())
            ...
            .excludePathPatterns("/api/page/collaborate-track/**")
            .excludePathPatterns("/api/page/collaborate-record/**")
            .excludePathPatterns("/api/page/collaborate-create/**")
            .excludePathPatterns("/api/page/collaborate-detail/**")
            .excludePathPatterns("/api/collaborate/**")
