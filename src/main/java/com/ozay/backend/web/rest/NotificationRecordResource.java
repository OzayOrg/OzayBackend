...
public class NotificationRecordResource {
    ...
    public ResponseEntity<?> updateNotificationRecord(@RequestBody NotificationRecord notificationRecord) {
        ...
        mailService.sendTrackComplete(notificationRecord.getMember().getEmail(), notificationRecord.isTrackComplete(), "Subject", notificationRecord.getTrackCompletedDate());
